...
(t/start "src/insane_noises/wave.glsl"
...
(o/definst tone [frequency 440] (o/sin-osc frequency))
...
(o/definst bell [frequency 440 duration 10
        ...
        component
         (fn [harmonic proportion]
           (* 1/2
              ...
              (o/sin-osc (* harmonic frequency))))
        whole
          (o/mix (map component harmonic-series proportions))]
    (o/detect-silence whole :action o/FREE)
    whole))
...
(defn graph [points]
  (let [highlow (fn [k]
    ...
    (q/sketch 
      :title "Time vs pitch"
      :target :perm-frame
      :setup (fn [] (q/smooth) (q/frame-rate 20) (q/background 200))
      :draw  (fn []
               (let [colours
                 ...
                 (doseq [{x :time y :pitch voice :part}
                   ...
                   (q/stroke-weight 5)
                   (q/fill 255)
                   (apply q/stroke (colours voice))
                   (q/ellipse
                     (* (q/width) x)
                     (- (* 2/3 (q/height)) (* 1/3 (q/height) y))
                     10 10)))) 
      :size [1024 768])
    points))
